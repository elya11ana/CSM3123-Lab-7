...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    Sensor lightSensor;
    TextView textview;//tempat utk simpan value utk sensor
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lightSensor = senseMan.getDefaultSensor(Sensor.TYPE_LIGHT);//kemungkinan sensor light takde dlm device

        if (lightSensor!= null) { //kalau takde kuarkan message
